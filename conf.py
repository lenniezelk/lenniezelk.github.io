...
BLOG_AUTHOR = "Leonard Kioi"  # (translatable)
BLOG_TITLE = "lk"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://lkioi.me/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://lkioi.me/"
BLOG_EMAIL = "lenny.kinyanjui.lk@gmail.com"
BLOG_DESCRIPTION = "Rants and musings of Leonard Kioi a sofware developer and cycling enthusiast from Nairobi, Kenya"  # (translatable)
